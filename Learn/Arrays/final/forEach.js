...
//INFO: forEach() loop function (another way to do same thing as above)
...
//* ================== forEach for Maps ENDS ==========================


//* ================== forEach for Sets ENDS ==========================

const currenciesUnique = new Set(['USD', 'GBP', 'USD', 'RS', 'EUR']);
